...
const tips = [
  { emoji: '📊', text: 'Usa los datos — el restaurante tiene un presupuesto de Ads que apenas gasta. Menciónalo.' },
...
export function RolePlayIntroScreen({ onStart }: Props) {
  return (
    <div className="anim">
      {/* Header label */}
      <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Tienes 5 minutos para convencer a <strong style={{ color: 'var(--text)' }}>Valentina</strong>, dueña de Heladería La Fiore, de implementar nuevas estrategias en Rappi.
        </p>
      </div>
